			...
			<!--
				...
				function validateGMOForm()
				{
					...
					{	
						...
						var queryString="?add=1"+"&name="+name+"&address1="+address1+"&address2="+address2+"&phonenumber1="+phonenumber1+"&phonenumber2="+phonenumber2+"&mobilenumber="+mobilenumber+"&username="+username+"&password="+password+"&designation="+designation+"&email="+email+"&district="+district;
						ajaxRequest.open("GET", "gmoregform.php"+queryString,true);
				...
				<tr>
					<td  class="formLabel">
						<br>	
							...
							<a href="#" onclick="javascript:validateGMOForm(); return false;">
