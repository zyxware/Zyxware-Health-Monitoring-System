...
class pagination {
  ...
  /**
   * Function for listing the page number
   * @return string HTML of the section
   */
  ...
  /**
   * Function for displaying the information of the listing.
   * @return string HTML of list information
   */
   ...
   * @param int $count
   * @param string $correctUrl Correct URL of the page
