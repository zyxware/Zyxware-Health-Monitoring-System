							...
							<table class="formTab">	
								<tr>
								  ...
								  echo'	<input type="text" name="txtName" id="txtName" maxlength="50" 
											...
											echo'><br>';}
								if($id !="view"){echo'<i> ( Enter Name of the Post office. )</i><br>';}
								...
								<tr>
								  ...
								  echo'<input type="text" name="txtPincode" id="txtPincode" 
										...
										echo'><br>';}
								if($id !="view"){echo'<i> ( Enter the pincode of the Post office. )
											</i><br>';}
								...
								echo'<tr>
									<td class="formLabel">
										Latitude'; if($id !="view"){echo' *';}
										echo'</td>
									<td class="formContent">';
									if($id =="view"){echo': '.$latitude;}
									else{
								...
								<tr>
									<td class="formLabel">
										Longitude'; if($id !="view"){echo' *';}
										echo'</td>
									<td class="formContent">';
									if($id =="view"){echo': '.$longitude;}
									else{
