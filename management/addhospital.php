...
function showMdlCol($UserType, $flag) {
  ...
  if ($UserType == "DAO" || $UserType == "GMO" || $UserType == "HOSPITAL" || $UserType == "ADMIN") {
    ...
    if ($flag == 'success') {
      ...
      if ($id != "view") {
        echo'<i> ( Enter Name of the Hospital. )</i><br>';
      }
      ...
      if ($id != "view") {
        echo'<i> ( Enter address of the Hospital. )</i><br>';
      }
      ...
      if ($id != "view") {
        echo' <i> ( Enter phone number of the Hospital. )</i>
										<br>';
      }
      ...
      if ($id != "view") {
        echo'<i>( Enter Register number of the Hospital. )</i>
										<br>';
      }
