	...
	if( $authorise =="GMO" || $authorise=="ADMIN" || $authorise=="DAO")
	{
		...
		else
		{
			...
			echo'<table class="tblForm">
				...
				<tr>
					<td>';
						if($strId !="view"){echo'<i> ( Fields marked with * are compulsary. )</i>';}
						echo'<form action="./addbulkcasereport.php"
							...
							<table class="formTab">	
								...
								<tr>
									<td class="formLabel">
										Reported cases'; if($strId !="view"){echo' *';}
									echo'</td>
									<td class="formContent">';
										if($strId =="view"){echo': '.$intReportedNo;}
										else
										{
								...
								if($strId =="view" || $strId =="edit")
								{
									echo'<tr>
										...
										<td class="formContent">';
											if($strId =="view"){echo': '.$dteCreatedon;}
											else
											{
